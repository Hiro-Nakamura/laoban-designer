...
import UIListEditMenuFactory from "./lb_common_popupEditMenu";
...
export default function (AB, options) {
   ...
   class UI_Common_List extends AB.ClassUI {
      constructor(attributes) {
         ...
         var base = attributes.idBase || "lb_common_list";
         super(base, {
            listSetting: "",
            list: "",
            searchText: "",
      ...
      bindDatacollection(DC) {
         // clear our list and display our objects:
         var List = this.$list;
         List.clearAll();
         List.data.unsync();
         List.data.sync(DC.__dataCollection);
         List.refresh();
         List.unselectAll();
      }
