// LBTaskHotspots
//
// A Hotspots task will loot any mobs nearby.
//
//
...
export default class LBTaskHotspots extends LBTask {
   static get key() {
      return _key;
   }
   static get name() {
...
*/
    ...
    */
   propertyDescription() {
      return "<b>Hotspots</b><br>A list of places to travel to.";
   }
