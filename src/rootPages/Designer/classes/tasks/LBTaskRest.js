// LBTaskRest
//
// A Rest task will cause the character to Eat/Drink
//
//
...
export default class LBTaskRest extends LBTask {
   static get key() {
      return _key;
   }
   static get name() {
...
*/
    ...
    */
   propertyDescription() {
      return "<b>Rest</b><br>Cause the character to eat/drink.";
   }
