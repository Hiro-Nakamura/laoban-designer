// LBTaskPar
//
// A Par task can manage a number of child tasks in PARallel.
//
//
...
export default class LBTaskPar extends LBTask {
   static get key() {
      return _key;
   }
   static get name() {
...
*/
    ...
    */
   propertyDescription() {
      return "<b>Par</b><br>Perform child tasks in parallel.";
   }
   ...
   //         'title':{
   //                     type:'comment',
   //                     template: '<b>Par</b><br>Perform child tasks in parallel.'
   //                 },
   //     };
