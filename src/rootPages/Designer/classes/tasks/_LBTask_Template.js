...
// LBTask[Task]
//
// A [Task] task will loot any mobs nearby.
//
// 
...
export default class LBTask[Task] extends LBTask {

    static get key() { return _key; }
    static get name() { return "[Task]"; }
...
*/
     ...
     */
    propertyDescription() {
        return '<b>[Task]</b><br>[Task] any mobs nearby.'
    }
